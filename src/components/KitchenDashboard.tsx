...
import { ChefHat, Clock, CheckCircle, Flame, ShoppingBag, MapPin } from 'lucide-react';
...
export const KitchenDashboard: React.FC<KitchenDashboardProps> = ({ orders, updateOrderStatus }) => {
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-white flex items-center gap-2">
                      ...
                      <span className={cn(
                        ...
                        order.orderType === 'pickup' ? "bg-blue-500/20 text-blue-400" : "bg-purple-500/20 text-purple-400"
                      )}>
